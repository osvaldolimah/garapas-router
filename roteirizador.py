...
# --- 2. DESIGN SYSTEM: SOLUÇÃO NUCLEAR + CENTRALIZAÇÃO ---
...
st.markdown("""
    ...
    * { box-sizing: border-box !important; }
    ...
    /* 3. GRID DA LISTA (HERDADO DO CLAUDE) */
    ...
    /* 4. CENTRALIZAÇÃO DOS BOTÕES (CORREÇÃO DO VAZAMENTO) */
    ...
    /* Força o conteúdo (emoji/ícone) a ficar no meio exato */
