...
# --- 3. DESIGN SYSTEM (LAYOUT INTELIGENTE SEPARADO) ---
...
st.markdown("""
    ...
    * { box-sizing: border-box !important; margin: 0 !important; }
    ...
    /* --- REGRAS GERAIS PARA COLUNAS (Topo e Padrão) --- */
    /* Por padrão, colunas ficam lado a lado e dividem o espaço igualmente */
    ...
    [data-testid="column"] {
        flex: 1 !important; /* Cada coluna ocupa espaço igual (50/50 ou 33/33/33) */
        min-width: 0 !important;
    }

    /* --- REGRA ESPECÍFICA PARA A LISTA DE ENTREGAS --- */
    /* Aqui aplicamos o Grid Travado do Claude SOMENTE dentro da div 'delivery-item-row' */
    .delivery-item-row [data-testid="stHorizontalBlock"] {
        display: grid !important;
        grid-template-columns: 56px 64px 1fr !important; /* AQUI ESTÁ A TRAVA */
        gap: 4px !important;
    }
    
    /* Removemos a flexibilidade das colunas DENTRO da lista para obedecerem o Grid acima */
    .delivery-item-row [data-testid="column"] {
        width: auto !important;
        flex: unset !important;
    }

    /* ESTILO GERAL DOS BOTÕES E INPUTS */
...
# --- 5. FRAGMENTO DA LISTA (COM CLASSE DE PROTEÇÃO CSS) ---
@st.fragment
def render_delivery_list():
    ...
    with st.container(height=500):
        for i, row in df_res.iterrows():
            ...
            # --- ENVOLVENDO OS BOTÕES DA LISTA NA CLASSE ESPECÍFICA ---
...
if st.session_state['df_final'] is None:
    ...
    # A. BOTÕES DE CONTROLE NO TOPO (AGORA FICAM NORMAIS 50/50)
    # Como não estão dentro da div 'delivery-item-row', usam o estilo padrão flex
